...
// String sTrans = "NULL";
// String[] sDistance = request.getParameterValues("sDistance");
// String[] sTime = request.getParameterValues("sTime");

// for (int i = 0; i< tbNO.length; i++) {
// 	System.out.println(tbNO[i]);
// 	System.out.println(sTrans[i]);
// 	System.out.println(sDistance[i]);
