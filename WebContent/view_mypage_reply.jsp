...
ArrayList <ReplyVo> rlist = rd.SelectViewMine(tbNO, LoginVo.getuNO());
int max = 0;
if (rlist != null) {
	max = rlist.size();
}
							...
							<ul class="review_list">
								<% 
									...
									<li>
										...
										<%if (LoginVo.getuNO().equals(rv.getuNO())) { %>
											<a href="javascript:DoDelete(<%= rv.getrNO() %>);" class="btn_rdel2" >
