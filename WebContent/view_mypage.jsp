		...
		<div class="container">
			...
			<div class="tourcouse_wrap view_tour cf">
				...
				<section class="tourplan_group">
					...
					<div class="tourplan_box">
						<ul class="tourplan_list cf swiper mySwiper">
						<%
						if (max != 0) {
							for (int i = 1; i <= max; i++) { 
...
<%-- 												<% if (max_order > Integer.parseInt(each_sv.getsOrder())) {  %> --%>
<!-- 												<li  class="move_box"> -->
<!-- 													<div class="tmove"> -->
<%-- 														<span class="move_icon"><%=each_sv.getsTrans() %></span> --%>
<!-- 													</div> -->
<!-- 													<div class="ttxt"> -->
<%-- 														<span class="time"><%=each_sv.getsTime() %></span> --%>
<%-- 														<span class="dis"><%=each_sv.getsDistance() %></span> --%>
<!-- 													</div> -->
<!-- 													<ul class="btn_list"> -->
<!-- 														<li> -->
<!-- 															<button type="button"><i class="icon_map fi fi-rr-map"></i><span class="blind">지도</span></button> -->
<!-- 														</li> -->
<!-- 													</ul> -->
<!-- 												</li> -->
<%-- 												<% } %> --%>
